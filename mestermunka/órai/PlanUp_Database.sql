...
('Dunaparti futóverseny', 'Csatlakozz egy ingyenes közösségi futáshoz a Dunaparton.', 'weekend', 'free', 'Duna-part', 'dunaparti-futoverseny.jpg'),
...
('Sas-hegyi napfelkelte túra', 'Csodáld meg a napfelkeltét a város felett.', 'weekend', 'free', 'Gellért-hegy', 'gellert-hegyi-napfelkelte.jpg'),
...
('Szabadtéri koncertek', 'Élvezd a város különböző pontjain megrendezett koncerteket.', 'weekend', 'paid', 'Kobuci Kert', 'szabadteri-koncert.jpg'),
...
('Kiállítás a Millenárison', 'Fedezd fel az aktuális művészeti kiállításokat.', 'weekend', 'paid', 'Millenáris Park', 'ingyenes-kiallitas.jpg'),
